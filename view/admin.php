...
<form id="foodForm" action="admin.ctr.php" method="POST" enctype="multipart/form-data" class=" hidden w-full max-w-md mx-auto p-6 text-gray-100 pl-4 border border-gray-100 rounded-lg">
    <div class="mb-4">
